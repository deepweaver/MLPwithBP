...
class BPN:
    def __init__(self, input_size=9, output_size=6, hidden_size1=90, hidden_size2=90, learning_rate=0.1):
        ...
        # self.dw1 = np.zeros((self.hidden_size1, self.input_size+1))
        # self.dw2 = np.zeros((self.hidden_size2, self.hidden_size1+1))
        # self.dw3 = np.zeros((self.output_size, self.hidden_size2+1))
...
if __name__ == "__main__":
    ...
    for e in range(epochs):
        ...
        for i in range(traininput.shape[1]):
            ...
            bpn.backward(traintarget[:,i:i+1], learning_rate=1-e/epochs) # 
